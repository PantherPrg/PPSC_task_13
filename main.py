from workplace import rotatingShapes # <- - - - - - - Workplace Function
import sys

# dont touch this stuff 

taskNum = 13 # <- - - - - Task Number
numtasks = 6 # <- - - - - Number of tasks, also edit files
variables = {}
perfect = True
...
for i in range(1, numtasks+1):
  ...
  variables["t{0}a".format(i)] = rotatingShapes(testCase1, testCase2)
